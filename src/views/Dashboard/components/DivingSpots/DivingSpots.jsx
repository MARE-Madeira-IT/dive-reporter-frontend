...
import { fetchSelector } from "redux_modules/divingSpots/actions";
        ...
        <div>
            <Row>
                <Divider orientation="left">
                    <div className={styles.title}> Diving Spots </div>
                </Divider>
            </Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(DivingSpots);
